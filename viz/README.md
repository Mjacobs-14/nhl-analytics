...
| `matchup_lab.html` | Two-team style-clash previews: EV + power-play terms (road-vs-home profiles × concessions × goalie band SV%, starter override), rush transition clash | `team_strength_location_v`, `goalie_location_v` |
